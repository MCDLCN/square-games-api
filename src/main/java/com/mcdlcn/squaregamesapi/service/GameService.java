...
public interface GameService {
    UUID createGame(UUID userId, GameCreationParams params) throws InconsistentGameDefinitionException;;
    ...
    GameStateDto playMove(UUID userId, UUID gameId, String tokenName, MoveParams moveParams) throws InvalidPositionException, InconsistentGameDefinitionException;

    Collection<GameStateDto> getGames(UUID userId) throws InconsistentGameDefinitionException;
}